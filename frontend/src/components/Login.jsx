      ...
      <div className="w-full max-w-md bg-dabba/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl flex flex-col gap-6 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <div className="relative flex py-1 items-center">
            ...
            <span className="flex-shrink mx-3 text-cream/40 text-xs font-mono uppercase">or</span>
            <div className="flex-grow border-t border-white/10"></div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/30 text-emerald-300 font-display font-semibold text-sm transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            <span>⚡ Explore as Guest / Instant Demo Mode</span>
          </button>
        </form>
